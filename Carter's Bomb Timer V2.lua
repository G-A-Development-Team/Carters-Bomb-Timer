...
callbacks.Register("Draw", function()
	...
	if entities.FindByClass("C_PlantedC4")[1] ~= nil then
		local Bomb = entities.FindByClass("C_PlantedC4")[1];	
		local BombMath = ((globals.CurTime() - Bomb:GetPropFloat("m_flC4Blow")) * (0 - 1)) / ((Bomb:GetPropFloat("m_flC4Blow") - Bomb:GetPropFloat("m_flTimerLength")) - Bomb:GetPropFloat("m_flC4Blow")) + 1;
		local bombtimer = math.floor((timePlanted - globals.CurTime() + Bomb:GetPropFloat("m_flTimerLength")) * 10) / 10
		...
		if defusing then
			BombMath = ((globals.CurTime() - Bomb:GetPropFloat("m_flDefuseCountDown")) * (0 - 1)) / ((Bomb:GetPropFloat("m_flDefuseCountDown") - Bomb:GetPropFloat("m_flDefuseLength")) - Bomb:GetPropFloat("m_flDefuseCountDown")) + 1;
